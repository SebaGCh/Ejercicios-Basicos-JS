...
var menorMayor = (numeroX, numeroY) => numeroX > numeroY ? (numeroX + " Es mayor que " + numeroY) : (numeroY + " Es mayor que " + numeroX) 
console.log(menorMayor(5,8))
console.log(menorMayor(8,5))
/* mayorMenor(5,3)
mayorMenor(3,8)
 */
